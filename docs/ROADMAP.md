...
| M3.2.5a/b | Stop/Yield. **a** (D62): `StopControl`, schema 15, per-vehicle stop service in core, signal composition, lifecycle — **implemented 2026-09-25**. **b**: the editor — Stop/Yield on the conflict dialog and table, a line marker on the canvas, en/th, save/reopen | a: `stop_control.*`, `stop_control_model.*`; b open |
