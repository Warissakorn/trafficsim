...
| M3.2.4a/b | Conflict-area editor. **a** (D60): Conflict areas tab, add-crossing / take-over / restore / edit / delete, canvas display, Problems jump, Run protection note, en/th — **implemented 2026-09-25**. **b**: canvas pointer gestures (click an area, cycle priority, drag a waiting line), overlapping-side readability, reopen evidence | a: `rightofway_editor.*`, `priority-ui`; b open |
