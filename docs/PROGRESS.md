...
## 2026-09-24 — M1.26.1, where the shares live
...
**Not done: the editor surface.** Nothing lets an author set a share yet — that is the rest of
M1.26.1, per `docs/NEXT.md`.
