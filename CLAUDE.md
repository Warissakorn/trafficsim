...
≈3 s of entry acceleration. **Next is M2.6, the owner's gate study: C1 with C4 recorded, judged by the owner — no timing
against Vissim (D38, D51), in `docs/M2_GATE.md`.** A decision's station along its Link is still M2.1; per-interval flows are M2.1.2 (D45).
